...
def transformlng(lng, lat):
    ...
    ret += (20.0 * math.sin(6.0 * lng * pi) + 20.0 * math.sin(
        2.0 * lng * pi)) * 2.0 / 3.0
    ret += (20.0 * math.sin(lng * pi) + 40.0 * math.sin(
        lng / 3.0 * pi)) * 2.0 / 3.0
...
def mercatortowgs84(x, y):
    ...
    lat = 180 / math.pi * (2 * math.atan(
        math.exp(y / 20037508.34 * 180 * math.pi / 180)) - math.pi / 2)
    return lng, lat
...
def convertor(cC, cD):
    ...
    cB = abs(cC.y) / cD[9]
    cE = cD[2] + cD[3] * cB + cD[4] * cB * cB + cD[5] * cB * cB * cB + cD[
        6] * cB * cB * cB * cB + cD[7] * cB * cB * cB * cB * cB + cD[
             8] * cB * cB * cB * cB * cB * cB
    if (cC.x < 0):
        T = T * -1
    else:
...
if __name__ == '__main__':
    print(wgs84tomercator(108.330206, 34.127571))
    print(wgs84tomercator(108.336889, 34.138388))
    print(wgs84tomercator(108.349897, 34.132472))
    print(wgs84tomercator(108.34307, 34.121475))
    print(wgs84tomercator(108.336602, 34.121415))
